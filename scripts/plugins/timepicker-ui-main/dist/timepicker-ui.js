  ...
  constructor(e) {
    (this.clean = () => {
      ...
      (this.create = () => {
        var e;
        if (
          !(this.clockFace && this.array && this.classToAdd && this.tipsWrapper)
        )
          return;
              ...
              (h.innerHTML = e),
                ...
                "24h" === this.clockType
                  ? (h.classList.add("timepicker-ui-value-tips-24h"),
                    t(h, "timepicker-ui-tips-disabled") || (h.tabIndex = 0))
            ...
            r &&
              ...
              ("AM" === o &&
                ...
                s.length > 0 &&
                  ...
                  (Number(l) === Number(c)
                    ? this._addClassesWithIncludes(r, s)
                    : Number(c) > Number(l) && this._addClasses(r)),
                "00" === a[0] &&
                  1 === a.length &&
                  s.length > 0 &&
                  (Number(l) === Number(c)
                    ...
                    : Number(c) > Number(l) && this._addClasses(r))),
              "PM" === o &&
                (c < Number(u) && this._addClasses(r),
                c === u && this._addClassesWithIncludes(r, a),
                a.length > 0 &&
                  Number(c) === u - 1 &&
...
exports.TimepickerUI = class {
  constructor(o, s) {
    ...
    (this.create = () => {
      ...
      (this._updateInputValueWithCurrentTimeOnStart = () => {
        ...
        if (
          ...
          const {
            ...
            minutes: i,
            type: t,
          } = u(this.input, this._options.clockType, this._options.currentTime);
      ...
      (this._removeBgColorToCirleWithMinutesTips = () => {
        (this.minutes.value && g.includes(this.minutes.value)) ||
          ((this.circle.style.backgroundColor = ""),
          ...
          null === (i = this.hour) ||
            ...
            i.addEventListener(e, (e) => {
              ...
              if (
                ...
                "12h" === this._options.clockType &&
                  (null === (r = this._options.disabledTime) || void 0 === r
                    ? void 0
                    : r.interval))
              ) {
                const e = new y({
      ...
      (this._handleEventToMoveHand = (e) => {
        ...
        const { target: he, type: ve, touches: be } = e,
          ke = he,
          {
            incrementMinutes: ge,
            incrementHours: ye,
            switchToMinutesAfterSelectHour: _e,
          } = this._options;
        ...
        if (null !== this.minutesTips) {
            ...
            if (
              ...
              if (
                ...
                (null === (k = this._disabledTime) || void 0 === k
                  ? void 0
                  : k.value.endType) ===
                  (null === (g = this.activeTypeMode) || void 0 === g
                    ? void 0
                    : g.textContent)
              )
                return;
                    ...
                    null ===
                      (_ =
                        null === (y = this._disabledTime) || void 0 === y
                          ...
                          : y.value) || void 0 === _
                      ? void 0
                      : _.startMinutes) || void 0 === T
                  ? void 0
                  : T.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                this.hour.value ===
                  (null ===
                    (x =
                      null === (f = this._disabledTime) || void 0 === f
                        ? void 0
                        : f.value) || void 0 === x
                    ? void 0
                    : x.removedStartedHour) &&
                (null === (w = this._disabledTime) || void 0 === w
                  ? void 0
                  : w.value.startType) ===
                  (null === (M = this.activeTypeMode) || void 0 === M
                    ? void 0
                    : M.textContent)
              )
                return;
              ...
              if (
                (null === (C = this.activeTypeMode) || void 0 === C
                  ? void 0
                  : C.textContent) ===
                  (null === (E = this._disabledTime) || void 0 === E
                    ? void 0
                    : E.value.endType) &&
                (((null ===
                  (S =
                    null ===
                      (L =
                        null === (H = this._disabledTime) || void 0 === H
                          ...
                          : H.value) || void 0 === L
                      ? void 0
                      : L.endMinutes) || void 0 === S
                  ? void 0
                  : S.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                  (null === (N = this._disabledTime) || void 0 === N
                    ? void 0
                    : N.value.removedPmHour) === this.hour.value) ||
                    ...
                    null ===
                      (W =
                        null === (I = this._disabledTime) || void 0 === I
                          ...
                          : I.value) || void 0 === W
                      ? void 0
                      : W.startMinutes) || void 0 === j
                  ? void 0
                  : j.includes(e <= 9 ? `0${e}` : `${e}`)) &&
                  (null === (F = this._disabledTime) || void 0 === F
                    ? void 0
                    : F.value.removedAmHour) === this.hour.value) ||
                  (null === (P = this._disabledTime) || void 0 === P
                    ? void 0
                    : P.value.amHours
                        .map(Number)
          ...
          (this.minutes.value = e >= 10 ? `${e}` : `0${e}`),
            ...
            n(
              ...
              "update",
              Object.assign(
                Object.assign({}, u(this.input, this._options.clockType)),
                {
                  degreesHours: this._degreesHours,
                  degreesMinutes: this._degreesMinutes,
                  eventType: ve,
                  type:
                    null === (D = this.activeTypeMode) || void 0 === D
                      ? void 0
                      : D.dataset.type,
                }
              )
        ...
        const we = be ? be[0] : void 0,
          Me =
            be && we ? document.elementFromPoint(we.clientX, we.clientY) : null;
        if (null !== this.hourTips) {
          if (
            (null === (q = this.hour) ||
              void 0 === q ||
              q.classList.add("active"),
            !t(Me || ke, "timepicker-ui-value-tips-24h") &&
              !t(Me || ke, "timepicker-ui-tips-disabled") &&
              (t(Me || ke, "timepicker-ui-value-tips") ||
                t(Me || ke, "timepicker-ui-tips-wrapper")))
          ) {
            let e,
            ...
            i < 0
              ...
              : ((e = Math.round(i / 30) % 12),
                (0 === e || e > 12) && (e = 12));
            const t = (
              null === (B = this._disabledTime) || void 0 === B
                ? void 0
                : B.value.isInterval
            )
              ? "rangeArrHour"
              ...
              if (
                ...
                if (
                  (null ===
                    ...
                    ? void 0
                    : K.endType) ===
                    (null === (X = this.activeTypeMode) || void 0 === X
                      ? void 0
                      : X.textContent) &&
                  (null ===
                    (G =
                      null === (J = this._disabledTime) || void 0 === J
                        ? void 0
                        : J.value) || void 0 === G
                    ? void 0
                    : G.startType) ===
                  ...
                  (null ===
                    (ie =
                      null === (ee = this._disabledTime) || void 0 === ee
                        ? void 0
                        : ee.value[t]) || void 0 === ie
                    ? void 0
                    : ie.includes(e.toString()))
                )
                  return;
              } else if (
                null ===
                  (ne =
                    null === (te = this._disabledTime) || void 0 === te
                      ? void 0
                      : te.value[t]) || void 0 === ne
                  ? void 0
                  : ne.includes(e.toString())
              )
                return;
            } else {
              if (
                (null === (re = this._disabledTime) || void 0 === re
                  ? void 0
                  : re.value.startType) ===
                  (null === (oe = this.activeTypeMode) || void 0 === oe
                    ? void 0
                    : oe.textContent) &&
                (null === (se = this._disabledTime) || void 0 === se
                  ? void 0
                  : se.value.amHours.includes(e.toString()))
              )
                return;
              if (
                (null === (ae = this._disabledTime) || void 0 === ae
                  ? void 0
                  : ae.value.endType) ===
                  (null === (le = this.activeTypeMode) || void 0 === le
                    ? void 0
                    : le.textContent) &&
                (null === (ue = this._disabledTime) || void 0 === ue
                  ? void 0
                  : ue.value.pmHours.includes(e.toString()))
              )
                return;
            }
            (this.clockHand.style.transform = `rotateZ(${i}deg)`),
          ...
          if (
            (t(Me || ke, "timepicker-ui-value-tips-24h") ||
              t(Me || ke, "timepicker-ui-tips-wrapper-24h")) &&
            !t(Me || ke, "timepicker-ui-tips-disabled")
          ) {
            let e,
              i = xe && r(Math.trunc((180 * xe) / Math.PI) + 90, ye, 30);
              ...
              null ===
                (pe =
                  null === (de = this._disabledTime) || void 0 === de
                    ? void 0
                    : de.value[t]) || void 0 === pe
                ? void 0
                : pe.includes(e.toString())
            )
              return;
            this._setCircleClockClasses24h(),
              (this.clockHand.style.transform = `rotateZ(${i}deg)`),
          ...
          n(
            ...
            Object.assign(
              Object.assign({}, u(this.input, this._options.clockType)),
              {
                ...
                eventType: ve,
                type:
                  null === (me = this.activeTypeMode) || void 0 === me
                    ? void 0
                    : me.dataset.type,
              }
            )
          ...
          if (t(this.modalElement, "mobile")) {
            ...
            !0 === e &&
              ...
              e &&
                (null === (n = this.hour) ||
                  void 0 === n ||
                  n.classList.remove("invalid-value"))),
              this.close()(),
              ...
              this.destroy(),
                ...
                setTimeout(() => {
                  if (
                    ...
                    const e = "PM" === l ? "AM" : "PM";
                    this["PM" === l ? "PM" : "AM"].classList.add("active"),
              ...
              this.destroy(),
                ...
                setTimeout(() => {
                  if (
                    ...
                    const e = "PM" === n ? "AM" : "PM";
                    this["PM" === n ? "PM" : "AM"].classList.add("active"),
                      this[e].classList.remove("active");
                  }
                }, 300);
            }, 300);
                ...
                if (
                  ...
                  const {
                    ...
                    u = () => {
                      ...
                      t(l, "timepicker-ui-value-tips-24h")
                        ? null == l || l.dispatchEvent(r)
                        : null === (n = null == l ? void 0 : l.childNodes[0]) ||
                          void 0 === n ||
                          n.dispatchEvent(r),
                        (this._isTouchMouseMove = !1);
                    };
          ...
          return (
                ...
                (v.push(void 0, h[h.length - 1]), h.pop()),
            {
              value: {
                ...
                rangeArrHour: h,
                isInterval: !0,
                startMinutes: o(l, 59).map((e) =>
                  Number(e) <= 9 ? `0${e}` : `${e}`
                ),
                endMinutes: s(0, p).map((e) =>
                  Number(e) <= 9 ? `0${e}` : `${e}`
                ),
                endType: m,
                startType: c,
  ...
  _setErrorHandler() {
    ...
    const {
      ...
      currentType: l,
      currentLength: c,
    } = u(this.input, this._options.clockType);
    if (o) {
